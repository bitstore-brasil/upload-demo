...
class ModelExtensionModuleDBlogModule extends Model
{
    ...
    public function createTables()
    {
        ...
        $this->db->query(" INSERT IGNORE INTO `" . DB_PREFIX . "layout` (`layout_id`, `name`) VALUES ('101', 'Blog categoria')");
        $this->db->query(" INSERT IGNORE INTO `" . DB_PREFIX . "layout` (`layout_id`, `name`) VALUES ('102', 'Blog busca')");
        $this->db->query(" INSERT IGNORE INTO `" . DB_PREFIX . "layout` (`layout_id`, `name`) VALUES ('103', 'Blog autor')");
