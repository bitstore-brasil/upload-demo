...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        cancelTitle: 'Interromper o upload em andamento',
        uploadLabel: 'Upload',
        uploadTitle: 'Upload arquivos selecionados',
        msgNo: 'Não',
        msgCancelled: 'Cancelado',
        msgZoomTitle: 'Ver detalhes',
        msgZoomModalHeading: 'Visualização detalhada',
        msgSizeTooLarge: 'Arquivo "{name}" (<b>{size} KB</b>) excede o tamanho máximo permitido de upload de <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Você deve selecionar pelo menos <b>{n}</b> {files} para upload.',
        msgFilesTooMany: 'Número de arquivos selecionados para upload <b>({n})</b> excede o limite máximo permitido de <b>{m}</b>.',
        msgFileNotFound: 'Arquivo "{name}" não encontrado!',
        msgFileSecured: 'Restrições de segurança impedem a leitura do arquivo "{name}".',
        msgFileNotReadable: 'Arquivo "{name}" não é legível.',
        msgFilePreviewAborted: 'Visualização de arquivo abortada por "{name}".',
        msgFilePreviewError: 'Ocorreu um erro ao ler o arquivo "{name}".',
        msgInvalidFileType: 'Tipo inválido para o arquivo "{name}". Somente "{types}" arquivos são suportados.',
        msgInvalidFileExtension: 'Extensão inválida para o arquivo "{name}". Somente "{extensions}" arquivos são suportados.',
        msgUploadAborted: 'O upload do arquivo foi abortado',
        msgValidationError: 'erro de validação',
        msgLoading: 'Loading arquivo {index} de {files} &hellip;',
        msgProgress: 'Loading arquivo {index} de {files} - {name} - {percent}% concluído.',
        msgSelected: '{n} {files} selecionado',
        msgFoldersNotAllowed: 'Arraste & solte apenas arquivos! {n} pasta(s) caiu foram ignorados.',
        msgImageWidthSmall: 'Largura do arquivo de imagem "{name}" deve ser pelo menos {size} px.',
        msgImageHeightSmall: 'Altura do arquivo de imagem "{name}" deve ser pelo menos {size} px.',
        msgImageWidthLarge: 'Largura do arquivo de imagem "{name}" não pode exceder{size} px.',
        msgImageHeightLarge: 'Altura do arquivo de imagem "{name}" não pode exceder {size} px.',
        msgImageResizeError: 'Não foi possível redimensionar as dimensões da imagem.',
        msgImageResizeException: 'Erro ao redimensionar a imagem.<pre>{errors}</pre>',
        dropZoneTitle: 'Arraste & solte arquivos aqui &hellip;'
    };
